    ...
    $(function() {
		...
		$( ".dropvideo_area" ).droppable({
			...
			drop: function( event, ui ) {
					...
					if ($.trim($(this).html())=='<p class="text_top_space">drop video <br>'+(temp_sort)+' here</p>'){
						...
						//alert($.trim(($(this).html()))+'\n'+'<p class="text_top_space">drop video <br>'+(temp_sort)+' here</p>');
						//alert('<p class="text_top_space">drop video <br>'+sort_order+' here</p>');
            ...
            <div class="main_playlist_area">
                ...
                <div class="playlist_center">
                    ...
                    <div class="dropvideo_area <?php if ($keys==0){?>drop_space<?php }else{?>drop_space1<?php }?>" id="sort_order_<?php echo $keys; ?>" sort_order="<?php echo $keys; ?>">
						...
						<?php }else{?>
                    	<p class="text_top_space">drop video <br><?php echo ($keys+1);?> here</p>
                        <?php }?>
                    </div>
                    <?php
						}
