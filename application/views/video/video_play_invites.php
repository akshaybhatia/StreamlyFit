...
<div class="friend_body_area">
	<div class="body_main_area">
    	<div class="big_video_area">
        	<div id="video_play" class="big_video">
            	<!--<img src="images/big_video.jpg" alt="" />-->
                <?php if ($this->session->userdata('user_id')==''){ ?>                      
            <a href="<?php echo $this->config->item('base_url'); ?>assets/uploads/video/<?php echo $result->video_sample; ?>" style="display:block; width:591px; height:333px; " id="player">
			<img src="<?php echo $this->config->item('base_url'); ?>assets/uploads/video/<?php echo $result->video_image; ?>" alt="<?php echo $result->video_caption; ?>" height="333" width="591" />	
			</a>
            ...
            <?php }else{?>            
       		<a href="<?php echo $this->config->item('base_url'); ?>assets/uploads/video/<?php echo $result->video_url; ?>" style="display:block; width:591px; height:333px; " id="player">
			<img src="<?php echo $this->config->item('base_url'); ?>assets/uploads/video/<?php echo $result->video_image; ?>" alt="<?php echo $result->video_caption; ?>" height="333" width="591" />	
			</a>     
            <?php }?>
