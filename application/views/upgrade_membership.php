...
<div class="signup_body_area">
	<div class="body_main_area">
    	<div class="signup_main_area_center">
			...
			<!-- 2nd Step -->
            <div class="2nd_step" style="display:block;">
                ...
                <div class="signup_center">
                   ...
                   <!-- <input type="text" class="city_fill1" value="" id="country" name="country" onblur="show_txt('country','text_country')" style="display:none" />
					...
					<div class="signup_main_form_area">
						...
						<div class="signup_main_form_area_left">
							<input type="text" class="card_number_fill1" value="" id="card_no" name="card_no" onblur="show_txt('card_no','text_card_no')" style="display:none" maxlength="16" />
                            <input type="text" class="card_number_fill1" value="Card Number" id="text_card_no" name="text_card_no" onfocus="show_pass('card_no','text_card_no')" onclick="show_pass('card_no','text_card_no')"   />
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="signup_main_form_area" style="margin-top:10px;">
						<div class="signup_col">
							<select name="exp_month" id="exp_month" class="month_area">
						...
						<div class="signup_col">
							<select name="exp_year" id="exp_year" class="month_area">
						...
						<div style="float:left;">
							<input type="text" class="city_fill1" value="" id="sec_code" name="sec_code" onblur="show_txt('sec_code','text_sec_code')" style="display:none" maxlength="4" />
                            <input type="text" class="city_fill1" value="Security Code" id="text_sec_code" name="text_sec_code"  onfocus="show_pass('sec_code','text_sec_code')" onclick="show_pass('sec_code','text_sec_code')"   />
						</div>
						<div class="clearfix"></div>
