...
<script type="text/javascript" src="<?php echo $this->config->item("base_url")?>assets/js/scrollto.js"></script>
...
<script type="text/javascript" language="javascript">
	...
	function scrollDown()
	{
		$('#tabs_content_container').ScrollTo({
			duration: 1000,
			easing: 'linear'
		});
	}
...
<body id="body_html" <?php if (!empty($uri_seg)){?>onload="scrollDown();" <?php } ?> >
<!--header Area-->
